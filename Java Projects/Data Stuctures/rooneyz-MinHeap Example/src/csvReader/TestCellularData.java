...
*/
		...
		totalSubscriptions = datatable.getNumSubscriptionsInCountryForPeriod("England",1990, 2000);
		System.out.printf("England (1990 to 2000): %.2f \n", totalSubscriptions);
		totalSubscriptions = datatable.getNumSubscriptionsInCountryForPeriod("Mexico",1975, 2020);
		System.out.printf("Mexico (1975 to 2020): %.2f \n", totalSubscriptions);
		totalSubscriptions = datatable.getNumSubscriptionsInCountryForPeriod("United States",1980, 2000);
		System.out.printf("United States (1980 to 2000): %.2f \n", totalSubscriptions);
		totalSubscriptions = datatable.getNumSubscriptionsInCountryForPeriod("United States",1955, 2014);
		System.out.printf("United States (1955 to 2014): %.2f \n", totalSubscriptions);
			}
}
